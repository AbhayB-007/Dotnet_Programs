...
namespace ExportToExcel
{
    public partial class frmExcelExport : Form
    {
        ...
        private DataSet GetDataSet()
        {
            ...
            dtbl2.Columns.Add("Rating_V2");
            dtbl2.Rows.Add("6", "War and Peace_V2", "Leo Tolstoy_V2", "Historical fiction_V2", "01-01-1869_V2", "133.95_V2", "4.1_V2", "Rating_V2");
            ds.Tables.Add(dtbl2);
            DataTable dtbl3 = dtbl.Copy();//Created copies of first table
            dtbl3.TableName = "Table3";
            dtbl3.Columns.Add("Rating_V3");
            dtbl3.Rows.Add("6", "War and Peace_V3", "Leo Tolstoy_V3", "Historical fiction_V3", "01-01-1869_V3", "133.95_V3", "4.1_V3", "Rating_V3");
            ds.Tables.Add(dtbl3);
