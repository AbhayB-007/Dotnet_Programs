namespace LINQSamples
{
    public class SamplesViewModel : ViewModelBase
    {
        ...
        public List<Product> TakeRangeQuery()
        {
            ...
            // Write Query Syntax Here
            list = (from prod in products orderby prod.ProductID select prod).Take(5..8).ToList();
        ...
        public List<Product> DistinctByMethod()
        {
            ...
            // Write Method Syntax Here
            list = products.DistinctBy(prod => prod.Color, default).OrderBy(p => p.Color).ToList();
